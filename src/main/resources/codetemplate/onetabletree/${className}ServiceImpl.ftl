...
public class ${className}ServiceImpl implements ${className}Service {
	...
	/*
	 * (non-Javadoc)
	 * @see ${service_package}.${className}Service#getAll()
	 */
	@Override
	public List<${className}> getAll() {
		return ${classNameLowerCase}Dao.findAll();
	}
	...
	/*
	 * (non-Javadoc)
	 * @see ${service_package}.${className}Service#get(<#list table.primaryKeyColumns as pkColumn>${pkColumn.javaType}<#if pkColumn_has_next>, </#if></#list>)
	 */
	@Override
	public ${className} get(<#list table.primaryKeyColumns as pkColumn>${pkColumn.javaType} ${pkColumn.columnNameLowerCase}<#if pkColumn_has_next>, </#if></#list>) {
