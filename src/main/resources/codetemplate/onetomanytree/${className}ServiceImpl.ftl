...
public class ${className}ServiceImpl implements ${className}Service {
	 ...
	 */
	public Integer removeAll${child.className}(List<${child.className}> ${child.classNameLowerCase}s) {
		return ${child.classNameLowerCase}Dao.deleteAll(${child.classNameLowerCase}s);
	}
	</#list>
}
