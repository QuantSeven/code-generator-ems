...
<#macro generateFields>
	...
	private ${child.className} ${child.classNameLowerCase};
	</#list>
	...
	public ${child.className} get${child.className}() {
		return this.${child.classNameLowerCase};
	}
	
	public void set${child.className}(${child.className} ${child.classNameLowerCase}) {
		this.${child.classNameLowerCase} = ${child.classNameLowerCase};
	}
